<div style="height: 200px;">
	...
	<div id="navbar">
			 <ul>
				...
				<?php if(isset($_SESSION['admin'])){echo '<li><a href="user_control_admin/view_user.php">User control</a></li>';}?>
				<?php if(!isset($_SESSION['admin'])&&!isset($_SESSION['user'])){echo '<li><a id= "login" href="views/admin/user/login.php">Đăng nhập</a></li>';} ?>
